...
> ### ⛔ 如果你而家係遙距連線（RDP），唔好開始。
>
> **遙距 session 係切換唔到帳戶嘅** —— 切換使用者係主控台先有嘅功能。RDP 入面撳
> Ctrl+Alt+Del 係去咗你自己部機，個保安畫面亦唔會俾你揀另一個 session。
>
> 即係話**第 2 步喺遙距根本冇掣可以撳**，而你會行到一半先發現。
>
> **要去到 AROMABRAIN 機面前，喺主控台登入，先開始。**
>
> 唔使靠你記住呢一點：第一個啟動器**開頭就會自己查**，查到係遙距會即刻停低出報告，
> 而且係喺**未郁過部機任何嘢之前**停。
...
| 佢寫住 | 意思 | 你做乜 |
|---|---|---|
| **PART B：通過**，同埋一行 **LOCK 5** | 成功 | 冇嘢做。將報告檔案路徑傳出去。 |
...
> ### 如果 Part B 冇通過，仲使唔使撳保留期檢查？
> ### **照撳。撳咗都唔會出事。**
>
> 個圖示自己會睇 Part B 嘅結果：未通過就會自己顯示
> **「Part B 未通過 —— 呢一步唔適用」**，然後咩都唔做 —— 唔會掃描、唔會刪嘢、唔會封存。
>
> **你唔需要喺機前面自己判斷。** 呢一頁唔會要你判斷任何嘢。

Part B 通過之後（或者你唔肯定通唔通過），喺**你自己個帳戶**嘅桌面撳：

> **Aroma 第四步 —— 保留期檢查**

Windows 會問你批唔批准，**揀「是」**。

睇最底：綠色 = Lock 3 通過；**琥珀色**「唔適用」= 冇嘢做過，正常；紅色 = 安全咁停低咗。
三種情況都一樣 —— **影一張相，然後停手。**
...
報告寫咗喺一個要提權先開到嘅資料夾。想攞返出嚟，喺**你自己個帳戶**嘅桌面撳：

> **Aroma 報告 —— 攞返驗收報告**

Windows 一樣會問你批唔批准，**揀「是」**。佢會把**所有**驗收回合抄去：

> `C:\Aroma\Commissioning-Reports`

嗰個資料夾你唔使提權都開得到，入面仲有一張 `INDEX.txt` 列晒每個檔。

呢一步幾時撳都得，撳幾多次都得 —— 佢淨係抄出嚟，唔會改動任何證據。
