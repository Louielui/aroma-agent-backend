...
> **HASH THESE FROM THE REPO, BEFORE APPLYING GATE B.** Once `restrict-probe-dir.ps1 -Apply`
> has run, `Get-FileHash` on a *staged* file fails for the Owner by design. After that, the
> staged hashes are reported by the probe itself at startup, in session 5 — compare that table
> against this one.

| file | SHA-256 | bytes |
|---|---|---|
| `observer.ps1` | `5281BC37E5EB028D5609680B4A10687C2D9BEC82954B7ABBFDE7341709F89FE9` | 14216 |
| `stage3-harness.ps1` | `0D93B3C36B9196CF54080D26D29B83877907A9D2110300148CEC76C483F7C7F7` | 37135 |
| `tierA-probe.ps1` | `9F1740E84F778F5A127DC831C101CAEE1FA4CF81AD5EB0A9010BA077C4368146` | 35454 |
| `assertionRegistry.ps1` **new** | `1F74BB928CE14922DEF0EC87798771380B9F87AEC8A66BAE795E7C05554FA573` | 12334 |
| `probeIdentityGate.ps1` **new** | `5024F24DE14F8D7BF7E7C9C485CB15497D75599095435361900FF54C4A4F9B69` | 3743 |
| `assertion-registry.json` **new** | `14CA4A07AFEA0CE8C322D08ADA8F1FB106F34FF81F80FCA8E3985248AF78EB9A` | 28526 |
| `stage3-topup.ps1` **new** | `C53A88620C00584C98D4A79C4AEF3D6DCBA6014096E544B089586578BEC08C88` | 45480 |
